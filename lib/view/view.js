...
exports.viewRoles = async () => {
  // Method to run sql queries from separqte sql file sourced from https://medium.com/@johnkolo/how-to-run-multiple-sql-queries-directly-from-an-sql-file-in-node-js-part-1-dce1e6dd2def
